...
class LeaderboardViewModel(
    ...
    private val leaderboardRepository: LeaderboardRepository   // pure interface — no impl import needed
) : ViewModel() {
    ...
    fun fetchTopScores(isRefresh: Boolean = false) {
        viewModelScope.launch {
            ...
            // FIX: call through the interface — no downcast, no impl dependency
            leaderboardRepository
                .getTopScoresByCategory(category, 100)
                .onSuccess { top100 ->
                    ...
                    if (currentUser != null) {
                        ...
                        if (index != -1) {
                            ...
                            leaderboardRepository.getUserData(currentUser.uid).onSuccess { user ->
                                if (user != null) {
                ...
                .onFailure {
                    // Scores stay as-is; UI can show stale data rather than crashing
                }
